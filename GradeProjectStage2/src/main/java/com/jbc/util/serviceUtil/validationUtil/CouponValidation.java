...
public interface CouponValidation extends TimeComparisonUtil, StringModifier {
	...
	public default void couponNullValidation(Coupon coupon)
		...
		boolean titleException = coupon.getTitle() == null || coupon.getTitle().isEmpty();
		boolean descException = coupon.getDescription() == null || coupon.getDescription().isEmpty();
		boolean imageException = coupon.getImage() == null || coupon.getImage().isEmpty();
