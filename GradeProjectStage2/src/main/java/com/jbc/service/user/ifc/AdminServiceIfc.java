...
public interface AdminServiceIfc {
	 ...
	 * @param email
	 * @param password
	 * @return {@code Entity} of the {@code User} with the {@code email} and
	 *         {@code password}.
	 */
	 ...
	 * @see user#Company
	 */
	public Company createCompany(long adminId,Company company) throws CompanyNullValueException, CompanyIsNullException,
			CompanyDuplicateValueException, CompanyAlreadyExistsException;
	 ...
	 * @see user#Company
	 */
	public Company updateCompany(long adminId,Company company) throws CompanyNullValueException, CompanyIsNullException,
			CompanyDuplicateValueException, CompanyNotFoundException;
	 ...
	 *                                         {@code null}
	 * @throws CustomerNullValueExceptio       if the {@code Company} {@code Entity}
	 *                                         has any {@code null} values in it.
	 * @see user#Customer
	 */
	public Customer addCustomer(long adminId,Customer customer) throws CustomerAlreadyExistsException,
			CustomerDuplicateValueException, CustomerIsNullException, CustomerNullValueException;
	 ...
	 * @see user#Customer
	 */
	public Customer updateCustomer(long adminId,Customer customer) throws CustomerDuplicateValueException, CustomerIsNullException,
			CustomerNullValueException, CustomerNotFoundException;
	...
	/**
	 * Deletes all the {@link com.jbc.model.Logger} {@code Entity}s in the system, aka: logs.
	 * 
	 * @param adminId
	 * @throws LoggerIsEmptyException if there is not a single {@code Logger}
	 *                                {@code Entity} in the system, aka: log.
